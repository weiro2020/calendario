...
function login_form()
{
	...
	return tag('form', attributes("action=\"$phpc_script\"",
				'method="post"'),
		tag('table',
			tag('caption', __('Ingreso de Administrador')),
                        tag('thead',
                                tag('tr',
			...
			tag('tbody',
				tag('tr',
					tag('th', tag('label', attributes('for="username"'), __('Usuario'))),
					tag('td', create_text('username'))),
				tag('tr',
					tag('th', tag('label', attributes('for="password"'), __('Contraseña'))),
